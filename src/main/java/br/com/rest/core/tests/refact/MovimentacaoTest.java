...
import br.com.rest.core.tests.Movimentacao;
...
public class MovimentacaoTest extends BaseTest {
    ...
    public void naoDeveRemoverContaComMovimentacao() {
        Integer CONTA_ID = FuncaoUtils.getIdContaPeloNome("Conta com movimentacao");
    ...
    public void deveRemoverMovimentacao() {
        Integer MOV_ID = FuncaoUtils.getIdMovPelaDescricao("Movimentacao para exclusao");
    ...
    private Movimentacao getMovimentacaoValida() {
        ...
        mov.setConta_id(FuncaoUtils.getIdContaPeloNome("Conta para movimentacoes"));
